...
// CODE HERE
let oneLineFn = (param1, param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}.`) 
...
function multiplyingFactory(x) {
    return function multiplicator(y){
        if(x >= 5){
            console.log(x * y)
        } else {
